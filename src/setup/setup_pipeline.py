...
def setup_pipeline(cfg: CVConfig | TrainConfig | SubmitConfig, *, is_train: bool = True) -> ModelPipeline | EnsemblePipeline:
    """Instantiate the pipeline.

    :param cfg: The model pipeline config. Root node should be a ModelPipeline or EnsemblePipeline
