...
def run_submit(cfg: SubmitConfig) -> None:
    """Run the main script for submitting the predictions."""
    print_section_separator("Onboarding Epoch V Competition - Submit")
    ...
    # Load the test data
    X = setup_inference_data(cfg.test_path)
    ...
    if predictions is not None:
        ...
        submission = to_submission_format(predictions, cfg.test_path)
